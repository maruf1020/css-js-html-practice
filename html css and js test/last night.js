...
//catch network call
function priceFromNetwork() {
    const send = XMLHttpRequest.prototype.send;
    XMLHttpRequest.prototype.send = function () {
        this.addEventListener("load", function () {

            if (this.status === 200 && this.responseURL.includes("graefe24.de/checkout/ajaxAddArticleCart")) {

                let cartContainer1 = new DOMParser().parseFromString(this.responseText, "text/html");
                let cartContainer = new DOMParser().parseFromString(this.responseText, "text/html").querySelector(".item--container");
